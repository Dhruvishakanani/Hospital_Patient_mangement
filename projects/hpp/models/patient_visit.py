...
class PatientVisit(models.Model):
    ...
    def print_payment_receipt(self):
        return self.env.ref('hospital_patient_portal.action_report_patient_visit_receipt').report_action(self)
    ...
    def action_view_payments(self):
        ...
        return {
            ...
            'name': 'Visit Payments',
            'res_model': 'account.payment',  # Replace with your payment model if custom
            'view_mode': 'list,form',
